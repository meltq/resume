...
% Skills
\section*{Skills}
C{\textbackslash}C++, Rust, Python, Linux Kernel, Device Drivers, Compilers, Embedded Systems, Machine Learning, Systems Engineering, NLP, LLM, Computer Vision, Transformers, Git
% Current Position
