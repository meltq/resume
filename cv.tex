...
% Skills
\section*{Skills}
C{\textbackslash}C++, Python, Rust, Linux, Device Drivers, Compilers, Embedded Systems, Machine Learning, Systems Programming, Containerization, LLM, Docker, CI/CD, Transformers, Git
% Current Position
